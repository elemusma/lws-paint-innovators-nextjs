  ...
  return (
    <>
      <ContentBlock
        ...
        columnClassName="lg:w-3/4 w-full relative px-5"
      >
        <div className="prose max-w-none">
          <h1 className="text-4xl font-bold mb-4">PRIVACY POLICY</h1>
          <p className="text-gray-600 mb-8">Last updated April 19, 2021</p>
          ...
          <p className="mb-4">
            Information entered into contact forms or employment applications -
            ...
            you voluntarily give to us when you choose to participate in various
          ...
          <p className="mb-4">
            ...
            information about our services from the. [We store only very
            ...
            ,] or [other], and you are encouraged to review their privacy policy
          ...
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">
              Contact you concerning applications or requests for information
              that you sent.
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">Solicit support for the Site.</li>
          ...
          <p className="mb-4">
            ...
            technologies on the Site and social media to help customize the Site
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">Website Analytics</h3>
          <p className="mb-4">
          ...
          <div className="mt-4">
            <p className="mb-1">Paint Innovators</p>
            <p className="mb-1">4823 Har-ber Avenue</p>
            <p className="mb-1">Springdale, AR 72762</p>
            <p className="mb-1">
              <a href="tel:(479)347-7521" className="text-accent">
                (479) 347-7521
              </a>
            </p>
            <p>
              <a
                href="mailto:Info@PaintInnovators.com"
                className="text-accent"
                target="_blank"
              >
                Email Us
