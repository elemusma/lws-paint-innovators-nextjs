...
export async function POST(req: Request) {
  try {
    ...
    const { first_name, last_name,user_email, location, feedback_type, service_completed, other_service, recommendation_likelihood, core_values_representation,comments, friendliness_satisfaction, knowledge_satisfaction, reliability_satisfaction, final_comments, embed_url } = body;
...
<p>Hi Paint Innovators! Someone submitted service feedback. See details below:</p>
